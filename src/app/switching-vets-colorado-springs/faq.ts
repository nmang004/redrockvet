...
// Colorado statutory right. They describe the general US pattern and route the reader to
// the Colorado State Board of Veterinary Medicine. Confirm this wording with the practice
// before publication if a Colorado-specific citation is later verified.
...
export const switchingVetsFaqs: ServiceFaq[] = [
  ...
  },
  {
    ...
    answer:
      "A standard exam is $79 and a same-day urgent exam is $109. A standard dental procedure is $999; extractions and oral surgery are billed separately and always discussed with you first. These are our current prices and they can change, so ask when you book. To become a client, call (719) 204-3647, text (719) 355-8343, or email Reception@RedRockVet.com with your name, your pet's name and species, and the name of your previous practice. We request the records, read them before your appointment, and you show up to a doctor who already knows the history. We are at 3163 W. Colorado Ave in Old Colorado City, open Monday through Friday, 8 a.m. to 5 p.m.",
  },
  {
...
export const switchingVetsFaqSchema = `{
  ...
  "mainEntity": [
    ...
    {"@type":"Question","name":"How do I transfer my pet's medical records to a new veterinarian?","acceptedAnswer":{"@type":"Answer","text":"Call or email the current practice and ask them to send a copy of the complete medical record to the new veterinarian. Ask specifically for the full visit history, vaccination records, laboratory and bloodwork results, imaging and radiographs, current medications with exact doses, and surgical and anesthetic records. Put the request in writing so there is a record of it, then confirm with the receiving practice that everything arrived. Red Rock Veterinary Health requests records on a new client's behalf: call (719) 204-3647, text (719) 355-8343, or email Reception@RedRockVet.com."}},
    {"@type":"Question","name":"Can a veterinarian refuse to give me my pet's records or withhold them over an unpaid balance?","acceptedAnswer":{"@type":"Answer","text":"In most states the physical or electronic chart is the property of the practice that created it, while the client is entitled to a copy of the pet's medical history rather than the original file. Colorado's specific requirements should be confirmed with the Colorado State Board of Veterinary Medicine rather than assumed. In practice most records requests are honored without friction, practices differ in how they handle a request while a balance is outstanding, and settling the balance removes the question. Rabies and vaccination certificates may also be on file with the authority the pet is licensed with."}},
